                ...
                <div className="flex justify-between items-center h-16">
                    <div className="flex items-center gap-8">
                        ...
                        {user.role === 'ADMIN' ? (
                            ...
                            <div className="flex gap-4 border-l pl-4 border-blue-700">
                                <Link to="/my-protection" className="hover:text-blue-300 text-sm">Mi Proteccion</Link>
                                <Link to="/member/events" className="hover:text-blue-300 text-sm">Eventos</Link>
                            </div>
                        )}
                    </div>
